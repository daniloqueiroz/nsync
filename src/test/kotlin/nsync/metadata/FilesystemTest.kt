...
class FilesystemTest {
    ...
    private lateinit var controlFile: AsyncFile<Index>
    private lateinit var inodesFile: AsyncFile<Inode>
...
//        Files.createDirectories(baseDir)
        ...
        controlFile = AsyncFile(baseDir.resolve("control"), Index)
        inodesFile = AsyncFile(baseDir.resolve("inodes"), Inode)
    }

    @Test
    fun emptyIndexFindReturnsNull() = asyncTest {
        val index = Filesystem(controlFile, inodesFile, "uid1")
    ...
    fun recordsDataAndFind_ReturnsIt() = asyncTest {
        ...
        val index = Filesystem(controlFile, inodesFile, "uid2")
